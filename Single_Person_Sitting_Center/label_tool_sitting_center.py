...
image_folder = Path("/Users/saklaen/Downloads/IR_Samples/Single_Person_Sitting_Center/Single_Person_Sitting_Center_image")
...
labels_file = Path(__file__).parent / "Single_Person_Sitting_Center"
...
if labels_file.exists():
    ...
    current_index = len(data.get("Single_Person_Sitting_Center", {}))
...
def save_label():
    print("Saving to Sitting Center...")
    ...
    if not labels_file.exists():
        data = {
            "Single_Person_Sitting_Center": {}
        }
    else:
        with open(labels_file, "r") as f:
            data = json.load(f)

        data.setdefault("Single_Person_Sitting_Center", {})

    data["Single_Person_Sitting_Center"][image_name] = matrix

    with open(labels_file, "w") as f:
        json.dump(data, f, indent=4)

    print(f"{image_name} saved!")
    print("Sitting Center count:", len(data["Single_Person_Sitting_Center"]))
...
image_name_label = tk.Label(
    control_frame,
    text="Image: Single_Person_Sitting_Center_0001",
    font=("Arial", 14, "bold")
)
