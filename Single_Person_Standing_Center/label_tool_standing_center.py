...
image_folder = Path("/Users/saklaen/Downloads/IR_Samples/Single_Person_Standing_Center/Single_Person_Standing_Center_image")
...
labels_file = Path(__file__).parent / "Single_Person_Standing_Center"
...
if labels_file.exists():
    ...
    current_index = len(data.get("Single_Person_Standing_Center", {}))
...
def save_label():
    print("Saving to Standing Center...")
    ...
    if not labels_file.exists():
        ...
        data.setdefault("Single_Person_Standing_Center", {})

    data["Single_Person_Standing_Center"][image_name] = matrix

    with open(labels_file, "w") as f:
        json.dump(data, f, indent=4)

    print(f"{image_name} saved!")
    print("Standing Center count:", len(data["Single_Person_Standing_Center"]))
...
image_name_label = tk.Label(
    control_frame,
    text="Image: Single_Person_Standing_Center_0001",
    font=("Arial", 14, "bold")
)
